...
class SelectRetraitContactPage extends StatefulWidget {
  String paymentMethod;
  String logoUrl;

  SelectRetraitContactPage(this.paymentMethod, this.logoUrl);
  @override
  _SelectRetraitContactState createState() => _SelectRetraitContactState();
}

class _SelectRetraitContactState extends State<SelectRetraitContactPage> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Text(
                'Selectionner le numero de retrait',
              ...
              onTap: () {
                Navigator.of(context).push(
                  CupertinoPageRoute(
                    ...
                    builder: (context) {
                      return WithdrawPage(widget.paymentMethod, widget.logoUrl);
                    },
                  ),
                );
              },
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'Ajoutez un nouveau pour le retrait',
                            style: TextStyle(
                                fontWeight: FontWeight.w600, fontSize: 15),
                          ),
                          Text(
